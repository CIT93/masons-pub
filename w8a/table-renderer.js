    ...
    // References the main carbon footprint table.
    const footprintTable = document.getElementById('footprintTable');
    // References the body element within the carbon footprint table.
    const footprintTableBody = footprintTable.querySelector('tbody');
    // References the message displayed when there are no entries.
    ...
    // References the Clear All Data button.
   ...
   const showDeleteConfirmingButtons = function(actionCell, id, onDeleteCallback) {
    ...
    const hideDeleteConfirmationButtons = function() {
        ...
        const confirmBtn = currentConfirmingRowElement.querySelector('.confirm');
        const cancelBtn = currentConfirmingRowElement.querySelector('.cancel');
    ...
    // 👇 THIS MUST BE OUTSIDE THE FUNCTION ABOVE
